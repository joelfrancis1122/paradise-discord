...
import pic from "./image.jpg" // Changed to WebP
...
export default function Home() {
  ...
  const fetchItems = async () => {
    try {
      const response = await axios.get("https://<render-url>/items") // Replace with your Render URL
      ...
      // Mock data fallback
      setItems([
        { id: "1", name: "VIP Role", price: 4.99, type: "roles" },
        { id: "2", name: "Premium Role", price: 9.99, type: "roles" },
        { id: "3", name: "Elite Role", price: 19.99, type: "roles" },
        { id: "4", name: "1 Month Boost", price: 4.99, type: "boosters" },
        { id: "5", name: "3 Month Boost", price: 12.99, type: "boosters" },
        { id: "6", name: "6 Month Boost", price: 24.99, type: "boosters" },
  ...
  return (
    <div className="min-h-screen bg-[#0a0d16] bg-[url('/background.webp')] bg-cover bg-center bg-no-repeat text-white font-sans relative overflow-hidden">
        ...
        <div className="md:col-span-1 bg-gradient-to-b from-[#1a0b2e]/80 to-[#4c1d95]/80 backdrop-blur-2xl border border-[#8b5cf6]/30 rounded-2xl p-4 shadow-[0_0_15px_rgba(139,92,246,0.5)] relative overflow-hidden">
          ...
          <div className="flex flex-col w-full bg-transparent space-y-3">
            <button
              ...
              className={`relative flex items-center gap-3 w-full justify-start p-3 text-left rounded-lg transition-all duration-300 ${
                activeTab === "roles"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                {items
                  ...
                  .map((item) => (
                    ...
                    >
                      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_10%_10%,rgba(255,255,255,0.2)_0%,transparent_50%)] opacity-20 hover:opacity-40 transition-opacity duration-300" />
                      <div className="bg-blue-500 p-3 rounded-full mb-3 shadow-[0_0_10px_rgba(59,130,246,0.7)]">
      ...
      {/* Footer */}
      <footer className="container mx-auto p-4 mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 bg-gradient-to-br from-[#1a0b2e]/80 to-[#0f172a]/80 backdrop-blur-2xl border border-[#8b5cf6]/30 rounded-2xl shadow-[0_0_15px_rgba(139,92,246,0.6)] md:animate-glow-pulse relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_50%,rgba(147,51,234,0.15)_0%,transparent_70%)] opacity-40 animate-pulse" />
        <div>
      ...
      <div className="container mx-auto p-4 text-center text-sm text-white/70 border-t border-[#8b5cf6]/20 mt-8 pt-4 bg-gradient-to-r from-[#1a0b2e]/80 to-[#0f172a]/80 backdrop-blur-md rounded-2xl shadow-[0_0_10px_rgba(139,92,246,0.5)]">
