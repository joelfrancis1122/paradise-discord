    ...
    return (
        <footer className="container mx-auto p-4 mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 bg-gradient-to-br relative overflow-hidden">
            ...
            <div>
                ...
                <p className="text-white/80"> <strong>Mirage is one of the most advanced, fastest-growing, and uniquely crafted communities on Discord.</strong> Built with passion and precision, Mirage brings together users from all walks of life to connect, play, and thrive in a vibrant, welcoming atmosphere. Whether you're here for games, social interaction, or just a place to chill, Mirage evolves constantly to deliver something truly special ❤️</p>
            </div>
            <div>
                <h3 className="text-xl font-extrabold text-[#a78bfa] mb-4 tracking-widest [text-shadow:_0_2px_4px_rgba(0,0,0,0.7)]">
                    Links
            ...
            <div>
                ...
                <p className="text-white/80 mb-4">
                    Reach out to us anytime if any question, issues or concern at&nbsp;
                    <a
                        href="mailto:official.mirage.team@gmail.com"
                        className="text-[#c4b5fd] hover:underline font-semibold"
                    >
                        official.mirage.team@gmail.com
                    </a>
